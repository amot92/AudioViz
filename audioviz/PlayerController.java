...
public class PlayerController implements Initializable {
    ...
    private boolean sliderIsClicked;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        timeSlider.setOnMousePressed((javafx.scene.input.MouseEvent event) -> {
    ...
    private void handleReady() {
        ...
        lengthText.setText(df2.format(duration.toSeconds()));
        Duration ct = mediaPlayer.getCurrentTime();
        currentText.setText(df2.format(ct.toSeconds()));
        currentVisualizer.start(numBands, vizPane);
        timeSlider.setMin(0);
